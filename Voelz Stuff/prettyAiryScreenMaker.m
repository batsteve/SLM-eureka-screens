...
%
% Calculate the weird Airy Stuff
%

rad = 32;
airyStuff = airy(0, rho/rad);
[rXX, rYY] = ndgrid(1:reducedN, 1:reducedN);
rXX = (rXX - reducedN/2)*d;
rYY = (rYY - reducedN/2)*d;
rRho = sqrt(rXX.^2 + rYY.^2);
redAiryStuff = airy(0, rRho/rad);
